                    ...
                    <div className="col-12">
                        <Form>
                            ...
                            <FormGroup row>
                                ...
                                <Col md={10}>
                                    <Input type="tel" name ="telnum" placeholder="Tel. Namber " value={ this.state.telNum }/>
                                </Col>
                            </FormGroup>
                            <FormGroup row>
                            ...
                            <FormGroup row>
                                ...
                                <Col md={10}>
                                    <Input type="textarea" name ="message" placeholder="Email" value={ this.state.message} rows = "12">
